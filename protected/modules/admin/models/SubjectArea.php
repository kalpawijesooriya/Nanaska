...
class SubjectArea extends CActiveRecord {
    ...
    public function search() {
        ...
        if (isset($_GET['SubjectArea']['level_id'])) {
            $criteria->compare('level_name', $_GET['SubjectArea']['level_id'], true);
        }
        
        if (isset($_GET['SubjectArea']['course_id'])) {
            $criteria->compare('course_name', $_GET['SubjectArea']['course_id'], true);
        }
        
        $criteria->compare('subject_area_id', $this->subject_area_id);
//        $criteria->compare('subject_id', $this->subject_id);
        $criteria->compare('subject.subject_name', $this->subject_id, true);
    ...
    public function getSubjectAreaDetails($subject_area_id) {
    ...
    public function getSubjectAreasForSubject($subject_id) {
        $criteria = new CDbCriteria;
        $criteria->addCondition('subject_id=' . $subject_id);
        $criteria->order = "subject_area_name ASC";
