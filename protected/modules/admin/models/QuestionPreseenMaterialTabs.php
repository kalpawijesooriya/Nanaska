...
class QuestionPreseenMaterialTabs extends CActiveRecord {
    ...
    public function getQuestionPreseenMatByQuestionPreseenMatId($question_preseen_material_id) {
        $data = Yii::app()->db->createCommand()
                ->select('*')
                ->from('question_preseen_material_tabs')
                ->where('question_preseen_material_id=:question_preseen_material_id', array(':question_preseen_material_id' => $question_preseen_material_id))
                ->queryAll();
