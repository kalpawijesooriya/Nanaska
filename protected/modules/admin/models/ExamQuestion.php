...
class ExamQuestion extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('exam_id, question_id, section_number', 'numerical', 'integerOnly' => true),
    ...
    public function getQuestionsOfExam($exam_id) {
    ...
    public function getExamDetailsForSuspend($question_id) {
        $data = Yii::app()->db->createCommand()
                ->select('e.*')
                ->from('exam_question q')
                ->join('exam e', 'q.exam_id=e.exam_id')
