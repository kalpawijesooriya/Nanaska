...
//            ),
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Sitting'])) {
            ...
            if ($model->save())
                $this->redirect(array('view', 'id' => $model->sitting_id));
        }
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Sitting');
    ...
    public function actionAdmin() {
        $model = new Sitting('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Sitting']))
            $model->attributes = $_GET['Sitting'];
    ...
    public function loadModel($id) {
        $model = Sitting::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'sitting-form') {
