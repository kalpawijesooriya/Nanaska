<h3 class="light_heading">Edit Privilege Levels</h3>
<br/>
<?php
...
<table>
    <tr>
        ...
        <td>
            <?php
            if ($model_lecturer_privilege['course_management'] == 0) {
                ?>
            ...
            if(data.status=="success"){
                            document.getElementById("unset_cm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_cm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
                document.getElementById("unset_cm_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="cm" type="hidden" value="1"/>

                <div id ="set_div_cm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            if(data.status=="success"){
                ...
                <div id ="unset_div_cm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
        ...
        <td>
            ...
            if ($model_lecturer_privilege['course_management'] == 0) {
                ?>
                <div class="span3" id="unset_cm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['level_management'] == 0) {
                ?>
                ...
                <div id ="set_div_lm" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_lm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_lm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_lm_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="lm" type="hidden" value="1"/>

                <div id ="set_div_lm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
                ...
                <div id ="unset_div_lm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
        ...
        <td>
            ...
            if ($model_lecturer_privilege['level_management'] == 0) {
                ?>
                <div class="span3" id="unset_lm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['subject_management'] == 0) {
                ?>
                ...
                <div id ="set_div_sm" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_sm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_sm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_sm_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="sm" type="hidden" value="1"/>

                <div id ="set_div_sm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            document.getElementById("unset_sm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_sm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['subject_management'] == 0) {
                ?>
                <div class="span3" id="unset_sm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['subject_area_management'] == 0) {
                ?>
                ...
                <div id ="set_div_sam" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_sam_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_sam" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_sam_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="sam" type="hidden" value="1"/>
                <div id ="set_div_sam" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            if(data.status=="success"){
                ...
                <div id ="unset_div_sam" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['subject_area_management'] == 0) {
                ?>
                <div class="span3" id="unset_sam_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['sitting_management'] == 0) {
                ?>
                ...
                <div id ="set_div_sim" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_sim_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_sim" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_sim_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="sim" type="hidden" value="1"/>

                <div id ="set_div_sim" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            document.getElementById("unset_sim_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_sim" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
         ...
         <td>
            ...
            if ($model_lecturer_privilege['sitting_management'] == 0) {
                ?>
                <div class="span3" id="unset_sim_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['news_management'] == 0) {
                ?>
                ...
                <div id ="set_div_nm" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_nm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_nm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_nm_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="nm" type="hidden" value="1"/>

                <div id ="set_div_nm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            document.getElementById("unset_nm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_nm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
         ...
         <td>
            ...
            if ($model_lecturer_privilege['news_management'] == 0) {
                ?>
                <div class="span3" id="unset_nm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            <?php
            if ($model_lecturer_privilege['country_management'] == 0) {
                ?>
                ...
                <div id ="set_div_com" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_com_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_com" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_com_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="com" type="hidden" value="1"/>

                <div id ="set_div_com" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            document.getElementById("unset_com_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_com" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
         ...
         <td>
            ...
            if ($model_lecturer_privilege['country_management'] == 0) {
                ?>
                <div class="span3" id="unset_com_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['student_management'] == 0) {
                ?>
                ...
                <div id ="set_div_stm" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_stm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_stm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_stm_status").innerHTML="<b>Denied<b>";
                ...
                <input id="stm" type="hidden" value="1"/>

                <div id ="set_div_stm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            document.getElementById("unset_stm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_stm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
        ...
        <td>
            ...
            if ($model_lecturer_privilege['student_management'] == 0) {
                ?>
                <div class="span3" id="unset_stm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['lecturer_management'] == 0) {
                ?>
                ...
                <div id ="set_div_lem" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_lem_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_lem" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
             document.getElementById("unset_lem_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="lem" type="hidden" value="1"/>

                <div id ="set_div_lem" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            if(data.status=="success"){
             document.getElementById("unset_lem_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_lem" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['lecturer_management'] == 0) {
                ?>
                <div class="span3" id="unset_lem_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['temporary_users'] == 0) {
                ?>
                ...
                <div id ="set_div_tm" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_tm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_tm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_tm_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="tm" type="hidden" value="1"/>

                <div id ="set_div_tm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            document.getElementById("unset_tm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_tm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['temporary_users'] == 0) {
                ?>
                <div class="span3" id="unset_tm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['exam_management'] == 0) {
                ?>
            ...
            if(data.status=="success"){
                    ...
                    document.getElementById("unset_em_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_em" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_em_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="em" type="hidden" value="1"/>

                <div id ="set_div_em" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            document.getElementById("unset_em_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_em" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['exam_management'] == 0) {
                ?>
                <div class="span3" id="unset_em_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['question_management'] == 0) {
                ?>
                ...
                <div id ="set_div_qm" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_qm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_qm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
             document.getElementById("unset_qm_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="qm" type="hidden" value="1"/>

                <div id ="set_div_qm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            if(data.status=="success"){
             document.getElementById("unset_qm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_qm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['question_management'] == 0) {
                ?>
                <div class="span3" id="unset_qm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['result_management'] == 0) {
                ?>
                ...
                <div id ="set_div_rm" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
            document.getElementById("unset_rm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_rm" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
            if(data.status=="success"){
              document.getElementById("unset_rm_status").innerHTML="<b>Denied<b>";
                ...
                <div id ="set_div_rm" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
            ...
            if(data.status=="success"){
              document.getElementById("unset_rm_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_rm" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['result_management'] == 0) {
                ?>
                <div class="span3" id="unset_rm_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
     ...
     <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['essay_answer_management'] == 0) {
                ?>
                ...
                <div id ="set_div_eam" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
                        if(data.status=="success"){
                            document.getElementById("unset_eam_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_eam" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
                        if(data.status=="success"){
                            document.getElementById("unset_eam_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="eam" type="hidden" value="1"/>

                <div id ="set_div_eam" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
                ...
                <div id ="unset_div_eam" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['essay_answer_management'] == 0) {
                ?>
                <div class="span3" id="unset_eam_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
      ...
      <tr>
        ...
        <td>
            ...
            <?php
            if ($model_lecturer_privilege['activity_logs'] == 0) {
                ?>
                ...
                <div id ="set_div_al" style="display: block">
                    ...
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
                        if(data.status=="success"){
                            document.getElementById("unset_al_status").innerHTML="<b>Allowed<b>";
                ...
                <div id ="unset_div_al" style="display: none">
                    ...
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        ...
                        'success' => 'function(data){ 
                        if(data.status=="success"){
                            document.getElementById("unset_al_status").innerHTML="<b>Denied<b>";
                ...
                ?>
                <input id="al" type="hidden" value="1"/>

                <div id ="set_div_al" style="display: none">
                    <?php
                    echo CHtml::ajaxButton('Allow', CController::createUrl('Lecturer/setPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
                ...
                <div id ="unset_div_al" style="display: block">
                    <?php
                    echo CHtml::ajaxButton('Deny', CController::createUrl('Lecturer/unsetPrivilegeLevel'), array(
                        'type' => 'POST', //request type
                        'dataType' => 'json',
          ...
          <td>
            ...
            if ($model_lecturer_privilege['essay_answer_management'] == 0) {
                ?>
                <div class="span3" id="unset_al_status">
                    <b>Denied</b>
                </div>
                <?php
            } else {
...
<br/><br/>
<?php
echo CHtml::ajaxButton('Save Changes', CController::createUrl('LecturerPrivilege/saveChangesPrivilegeLevels'), array(
    'type' => 'POST', //request type
    'dataType' => 'json',
    'data' => array(
        'lecturer_id' => $model->lecturer_id,
        'lecturer_privilege_id' => $model_lecturer_privilege['lecturer_privilege_id'],
        'cm' => 'js:cm.value',
        'lm' => 'js:lm.value',
        'sm' => 'js:sm.value',
        'sam' => 'js:sam.value',
