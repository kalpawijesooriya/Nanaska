...
//);
    ...
    <div class="span6"> 
        ...
        <div class="well well-no-background">
            ...
            <div class="control-group">
                <?php echo $form->labelEx($model, 'current_password', array('class' => 'control-label' , 'style' => 'padding-right: 10px')); ?>
...
<?php echo $form->error($model, 'current_password'); ?>
            ...
            <div class="control-group">
                <?php echo $form->labelEx($model, 'new_password', array('class' => 'control-label'  , 'style' => 'padding-right: 10px')); ?>
...
<?php echo $form->error($model, 'new_password'); ?>
            ...
            <div class="control-group">
                <?php echo $form->labelEx($model, 'repeat_new_password', array('class' => 'control-label'  , 'style' => 'padding-right: 10px')); ?>
