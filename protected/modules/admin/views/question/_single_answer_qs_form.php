...
<h4>Add answers for Single answer questions</h4>
<div class="span2">
...
<div id="text-answer" class="span5" style="margin-left: 0px;" >
    <table id="options-table" class="table">
        <tr id="tr_0" class="span5" style="margin-left: 0px;">
            ...
            <td><input type="button" class="del" value='Delete Answer' class="btn" onclick="deleteAnswer('tr_0','txt_0','acheck_0')"/></td>
        </tr>                  
        <tr id="tr_1" class="span5" style="margin-left: 0px;">
            ...
            <td><input type="button" class="adds" value="Add Answer" class="btn"/></td>
        </tr>
    </table>
</div>
...
<div id="image-answer" class="span5" style="margin-left: 0px; ">
    <table id="image-answer-table" class="table">  
        <tr id="imgtr_0" class="span5" style="margin-left: 0px;">
            ...
            <td><input type="button" class='imgdel' value='Delete Answer' onclick="deleteImageAnswers('imgtr_0','imgfile_0','imgch_0')" class="btn"/></td>
        </tr>                  
        <tr id="imgtr_1" class="span5" style="margin-left: 0px;">
            ...
            <td><input type="button" class="imgadds" value="Add Answer" class="btn"/></td>
        </tr>
    </table>
...
<script type="text/javascript">
    ...
    function deleteAnswer(tr,txt,check)
    {
