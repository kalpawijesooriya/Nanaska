...
?>
<h2 class="light_heading">Set Pre-Seen Materials for Exam <?php echo $model->exam_id; ?></h2>
<br/>
...
<div id="preseen" class="well" style="display: block">
    ...
    <div class="tab-content">
        <div id="pre1" class="tab-pane fade in active">
            ...
            <div class="span2">
                <input type="checkbox" id="image_answer1" value="image_answer1" name="ref_answer1" class="checkbox-margined"><span id="answercheck-text">Reference as Pdf</span>
            </div>
            <br />
            <br />
            Tab Title 1&nbsp;&nbsp;&nbsp;
            ...
            <div id="textarea1">
                Pre Seen Material Text<br/><br/>
                <textarea name="pre_formula_1" id="pre_formula_1" class="mceEditor"></textarea>                
            </div>

            <div id="ref_image_answer1">
                <div class="span2" style="margin-left: 0px">Upload reference material</div><div class="span2"><input type="file" name="ref_file1" id="ref_file1" accept="pdf"></div>
            </div>
        </div>
        ...
        for ($i = 2; $i < 16; $i++) {
            ...
            echo '</div>';
            echo '<div class="span2">';
            echo '<input type="checkbox" id="image_answer' . $i . '" value="image_answer' . $i . '" name="ref_answer' . $i . '" class="checkbox-margined"><span id="answercheck-text">Reference as Pdf</span>';
            echo '</div>';
            echo '<br />';
            echo '<br />';
            ...
            //pdf content
            echo '<div id="ref_image_answer' . $i . '"><div class="span2" style="margin-left: 0px">Upload reference material</div><div class="span2"><input type="file" name="ref_file' . $i . '" id="ref_file' . $i . '" accept="pdf"></div>
                </div>';
...
<div class="row">
    <div class="span2">
        <?php
        echo CHtml::button('Save Materials', array('submit' => array('exam/savePreseenMaterials'), 'class' => 'smallbluebtn'));
        ?>
    </div>
</div>
