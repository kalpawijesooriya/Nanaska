...
?>
<h2 class="light_heading">Set Instructions for Exam <?php echo $model->exam_id; ?></h2>
<br/>
...
<div class="row">
    <div class="span2">
        <?php
        echo CHtml::button('Save Instructions', array('submit' => array('exam/saveExamInstructions'), 'class' => 'smallbluebtn'));
        ?>
    </div>
</div>
