...
class ExamTablesAndFormulae extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('exam_id, tables_and_formulae_text, tab_position', 'required'),
			array('exam_id, tab_position', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('exam_tables_and_formulae_id, exam_id, tables_and_formulae_text, tab_position', 'safe', 'on'=>'search'),
		);
	}
