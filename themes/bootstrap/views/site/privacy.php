...
<div class="container">
    ...
    <div class="span8">
        ...
        <p>To process your enquiries and assessment quizzes or surveys, we collect your name, CIMA ID, email and postal addresses, daytime phone number, and, if applicable, company and type of business.</p>
        
        <p>To process enrolments and orders, we ask for your name, CIMA ID, email and postal addresses, daytime phone number, company name and address, training manager's name, mobile and home telephone numbers, date of birth, professional certification or registration information, if any, and credit or debit card information.</p>
       
        <p>In addition, the mobile applications may collect certain information automatically, including, but not limited to, the type of mobile device you use, your mobile devices unique device ID, the IP address of your mobile device, your mobile operating system, the type of mobile internet browsers you use, and information about the way you use the applications.</p>
        ...
        <p>If you enroll in any of our programmes, we will share your data with AAT, ACCA and CIMA. Please note that this is limited to sharing individual data only with the relevant institution.</p>
