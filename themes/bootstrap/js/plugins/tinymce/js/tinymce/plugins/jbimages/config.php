...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] ='images/question_images'; // Relative to domain name
	$config['upload_path'] = dirname(__FILE__) . '/../../../../../../../../../' . $config['img_path']; // Physical path. [Usually works fine like this]
